...
public class TwitterClient extends OAuthBaseClient {
	...
	public void checkStatus(long id, JsonHttpResponseHandler handler){
	...
	public void Like(boolean liked, long id, JsonHttpResponseHandler handler){
		String apiUrl;
		if(liked){
	...
	public void Retweet(boolean retweeted, long id, JsonHttpResponseHandler handler){
		String apiUrl;
		if(retweeted){
